...
const CardExperience = ({
  ...
  description,
  tecnologies,
  titlePropTecnology = "Tecnologias",
}: CardProp) => {
  return (
    <div className="grid grid-cols-3 py-3 group hover:bg-slate-700/10 rounded-lg transition-[background] max-md:grid-cols-1 max-md:px-3 ">
      ...
      <div className="col-span-2 ">
        <p className="text-slate-200 font-medium group-hover:text-green-500 ">
          {" "}
          {title}{" "}
        </p>
        <p className="text-slate-200 font-medium py-2 group-hover:text-green-500">
          {" "}
          {enterprice}{" "}
        </p>
        <p className="max-w-full"> {description} </p>
        <div>
          <p className="text-slate-200 py-2 group-hover:text-green-500">
            {titlePropTecnology}
          </p>
